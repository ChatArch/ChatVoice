...
- **Deployment and Startup**
    ...
    From `python -m pip install "ChatVoice[web]==0.1.4"` to `chatvoice serve app`, including runtime paths, account provisioning, ASR API provider wiring, and database concurrency boundaries.
...
- v0.1.4 defaults to SQLite WAL for one service process and light concurrency; high-concurrency storage migration needs a separate release.
