...
- **Deployment and Startup**
    ...
    From `python -m pip install "ChatVoice[web]==0.1.15.post1"` to `chatvoice serve app`, including runtime paths, account provisioning, ASR API provider wiring, and database concurrency boundaries.
