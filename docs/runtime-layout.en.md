...
This page documents where `pip install "ChatVoice[web]==0.2.0"` installs code, where runtime data is written by default, and which data lives in SQLite versus the browser.
